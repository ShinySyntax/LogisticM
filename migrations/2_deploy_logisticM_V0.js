...
const ERC721LogisticMImplementation = artifacts.require('./ERC721LogisticMImplementation.sol')
...
module.exports = async (deployer) => {
  ...
  await deployer.deploy(ERC721LogisticMImplementation)
  ...
  await ownedRegistry.addVersionFromName(version, 'initializeERC721()', ERC721LogisticMImplementation.address)
  await ownedRegistry.addVersionFromName(version, 'mint(address)', ERC721LogisticMImplementation.address)
  await ownedRegistry.addVersionFromName(version, 'getCounter()', ERC721LogisticMImplementation.address)
  await ownedRegistry.addVersionFromName(version, 'balanceOf(address)', ERC721LogisticMImplementation.address)
  await ownedRegistry.addVersionFromName(version, 'ownerOf(uint256)', ERC721LogisticMImplementation.address)
  await ownedRegistry.addVersionFromName(version, 'safeTransferFrom(address,address,uint256)', ERC721LogisticMImplementation.address)
  await ownedRegistry.addVersionFromName(version, 'transferFrom(address,address,uint256)', ERC721LogisticMImplementation.address)
  await ownedRegistry.addVersionFromName(version, 'approve(address,uint256)', ERC721LogisticMImplementation.address)
  await ownedRegistry.addVersionFromName(version, 'getApproved(uint256)', ERC721LogisticMImplementation.address)
  await ownedRegistry.addVersionFromName(version, 'setApprovalForAll(address,bool)', ERC721LogisticMImplementation.address)
  await ownedRegistry.addVersionFromName(version, 'isApprovedForAll(address,address)', ERC721LogisticMImplementation.address)
  await ownedRegistry.addVersionFromName(version, 'safeTransferFrom(address,address,uint256,bytes)', ERC721LogisticMImplementation.address)
  await ownedRegistry.addVersionFromName(version, 'name()', ERC721LogisticMImplementation.address)
  await ownedRegistry.addVersionFromName(version, 'symbol()', ERC721LogisticMImplementation.address)
  await ownedRegistry.addVersionFromName(version, 'tokenURI(uint256)', ERC721LogisticMImplementation.address)
  await ownedRegistry.addVersionFromName(version, 'totalSupply()', ERC721LogisticMImplementation.address)
  await ownedRegistry.addVersionFromName(version, 'tokenOfOwnerByIndex(address,uint256)', ERC721LogisticMImplementation.address)
  await ownedRegistry.addVersionFromName(version, 'tokenByIndex(uint256)', ERC721LogisticMImplementation.address)
  await ownedRegistry.addVersionFromName(version, 'supportsInterface(bytes4)', ERC721LogisticMImplementation.address)
